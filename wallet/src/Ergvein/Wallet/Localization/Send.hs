...
instance LocalizedPrint FeeStrings where
  localizedShow l v = case l of
    English -> case v of
      ...
      FSLevelDesc lvl f -> "~" <> showt f <> " satoshi/vbyte. <" <> showt (feeTargetBlocks Bitcoin lvl) <> " blocks."
    ...
    Russian -> case v of
      ...
      FSLevelDesc lvl f -> "~" <> showt f <> " satoshi/vbyte. <" <> showt (feeTargetBlocks Bitcoin lvl) <> " блоков."
      FSFee f -> "~" <> showt f <> " satoshi/vbyte"
